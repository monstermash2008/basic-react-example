import { pgTable, serial, text, integer, boolean, json, primaryKey } from 'drizzle-orm/pg-core';
...
export const pokemon = pgTable('pokemon', {
  ...
  // Keeping speciesId for now to avoid breaking changes, but it's redundant
...
export const pokemonGenerations = pgTable('pokemon_generations', {
  pokemonId: integer('pokemon_id')
    .notNull()
    .references(() => pokemon.id),
